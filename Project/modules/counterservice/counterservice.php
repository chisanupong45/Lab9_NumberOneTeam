...
class CounterService extends PaymentModule
{
    public function __construct()
    {
        $this->name = 'counterservice';
        ...
        $this->displayName = $this->l('CounterService');
        $this->description = $this->l('Accept payments with Counter Service.');
    }
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $newOption->setCallToActionText($this->l('ชำระผ่านเคาท์เตอร์เซอร์วิส'))
    ...
    public function hookPaymentReturn($params)
    {
        ...
        if ($params['order']->getCurrentState() == Configuration::get('PS_OS_PAYMENT')) {
            ...
            $message = $this->l('Your payment via Counter Service account was successful.');
