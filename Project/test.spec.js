...
test('US01 : TC02 | ทำการกด ลบ เพิ่ม Voucher ในตะกร้า ', async ({ page }) => {
  await page.goto('http://localhost:8080/th/');
...
test('US02 : TC04 | เลือกวิธีชำระเงิน Promptpay', async ({ page}) => {
  await page.goto('http://localhost:8080/th/');
...
test('US02 : TC05 | เลือกวิธีชำระเงิน QR code', async ({ page}) => {
  await page.goto('http://localhost:8080/th/');
  await page.locator('article').filter({ hasText: ' เปิดหน้าต่างย่อ บัตรกำนัล ฿100.00 ใหม่ favorite_border' }).getByRole('link').first().click();
  await page.getByRole('button', { name: ' หยิบใส่ตะกร้า' }).click();
  await page.getByRole('link', { name: ' ทำรายการชำระเงิน' }).click();
...
test('US02 : TC06 | เลือกวิธีชำระเงินโดยเลขบัญชี', async ({ page}) => {
  await page.goto('http://localhost:8080/th/');
  await page.locator('article').filter({ hasText: ' เปิดหน้าต่างย่อ บัตรกำนัล ฿100.00 ใหม่ favorite_border' }).getByRole('link').first().click();
  await page.getByRole('button', { name: ' หยิบใส่ตะกร้า' }).click();
  await page.getByRole('link', { name: ' ทำรายการชำระเงิน' }).click();
...
test('US02 : TC07 | เลือกวิธีชำระเงิน counter service', async ({ page}) => {
  await page.goto('http://localhost:8080/th/');
  await page.locator('article').filter({ hasText: ' เปิดหน้าต่างย่อ บัตรกำนัล ฿100.00 ใหม่ favorite_border' }).getByRole('link').first().click();
  await page.getByRole('button', { name: ' หยิบใส่ตะกร้า' }).click();
  await page.getByRole('link', { name: ' ทำรายการชำระเงิน' }).click();
...
test('US02 : TC08 | เลือกวิธีชำระเงิน counter service', async ({ page}) => {
  await page.goto('http://localhost:8080/th/');
  await page.locator('article').filter({ hasText: ' เปิดหน้าต่างย่อ บัตรกำนัล ฿100.00 ใหม่ favorite_border' }).getByRole('link').first().click();
  await page.getByRole('button', { name: ' หยิบใส่ตะกร้า' }).click();
  await page.getByRole('link', { name: ' ทำรายการชำระเงิน' }).click();
